...
require github.com/go-openapi/swag v0.23.0 // indirect
...
require (
	...
	github.com/go-openapi/jsonreference v0.20.2 // indirect; indirect	github.com/go-openapi/swag v0.23.0 // indirect
